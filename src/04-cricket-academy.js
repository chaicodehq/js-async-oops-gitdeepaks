...
export class Batsman extends Player {
  constructor(name, age, team, battingStyle) {
    super(name, age, team); // Player ka constructor pehle
  ...
  getProfile() {
    return {
      ...super.getProfile(), // Player ka sab kuch spread
      battingStyle: this.battingStyle,
      role: "batsman", // "player" ko override karo
...
export class Bowler extends Player {
  ...
  getEconomy() {
    ...
    const total = this.spells.reduce((sum, sp) => sum + sp.economy, 0);
  ...
  getProfile() {
    return {
      ...
      role: "bowler",
      totalWickets: this.spells.reduce((sum, sp) => sum + sp.wickets, 0),
      spellsBowled: this.spells.length,
    };
  }
}
...
// ============================================================
// ALLROUNDER — extends Player (Batsman + Bowler dono ka kaam)
// ============================================================
